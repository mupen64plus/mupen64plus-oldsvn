...
tc1_loop:
   ...
   asm volatile (
        ...
        // aaaa rrrr gggg bbbb
         "mov %%eax, %%edx       \n"
         "and $0x80008000, %%eax \n"
         "mov %%eax, %%ebx       \n"                // ebx = 0xa000000000000000
         "shr $1, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = 0xaa00000000000000
         "shr $1, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = 0xaaa0000000000000
         "shr $1, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = 0xaaaa000000000000

         "mov %%edx, %%eax       \n"
         "and $0x78007800, %%eax \n"        // eax = 0x0rrrr00000000000
         "shr $3, %%eax          \n"                // eax = 0x0000rrrr00000000
         "or %%eax, %%ebx        \n"                // ebx = 0xaaaarrrr00000000
         
         "mov %%edx, %%eax       \n"
         "and $0x03c003c0, %%eax \n"        // eax = 0x000000gggg000000
         "shr $2, %%eax          \n"                // eax = 0x00000000gggg0000
         "or %%eax, %%ebx        \n"                // ebx = 0xaaaarrrrgggg0000
         
         "and $0x001e001e, %%edx \n"        // edx = 0x00000000000bbbb0
         "shr $1, %%edx          \n"                // edx = 0x000000000000bbbb
         "or %%edx, %%ebx        \n"                // ebx = 0xaaaarrrrggggbbbb
         ...
         //"jnz tc1_loop2          \n"
         "jnz 0b \n"
         : [_src]"+S"(_src), [_dst]"+D"(_dst), "+c"(_size)
         :
...
tc1_loop:
   ...
   asm volatile (
         ...
         "or %%edx, %%ebx        \n"                // ebx = 0xaaaaiiii00000000
         "shr $4, %%edx          \n"                // edx = 0x00000000iiii0000
         "or %%edx, %%ebx        \n"                // ebx = 0xaaaaiiiiiiii0000
         "shr $4, %%edx          \n"                // edx = 0x000000000000iiii
         "or %%edx, %%ebx        \n"                // ebx = 0xaaaaiiiiiiiiiiii
...
tc1_loop:
   ...
   asm volatile (
         ...
         "mov %%eax, %%ebx       \n"                // ebx = a1 00 00 00 00 00 00 00
         "shr $4, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = a1 a1 00 00 00 00 00 00
         "shr $4, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = a1 a1 a1 00 00 00 00 00
         "shr $4, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = a1 a1 a1 a1 00 00 00 00
         ...
         "mov %%eax, %%ebx       \n"                // ebx = a3 00 00 00 00 00 00 00
         "shr $4, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = a3 a3 00 00 00 00 00 00
         "shr $4, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = a3 a3 a3 00 00 00 00 00
         "shr $4, %%eax          \n"
         "or %%eax, %%ebx        \n"                // ebx = a3 a3 a3 a3 00 00 00 00
         ...
         //"jnz tc1_loop           \n"
         "jnz 0b \n"
         : [src]"+S"(_src), [_dst]"+D"(_dst), "+c"(_size)
         :
