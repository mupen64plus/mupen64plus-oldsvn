...
#include "backend/r4300/recomph.h"
#include "backend/r4300/interupt.h"

#include "backend/memory/memory.h"

#include "backend/opengl/osd.h"
#include "backend/opengl/screenshot.h"
...
void startEmulation(void)
{
    ...
    */
    ...
    {
        main_message(0, 1, 0, OSD_BOTTOM_LEFT,  tr("Emulation started"));
        emulationThread(NULL);
    }
