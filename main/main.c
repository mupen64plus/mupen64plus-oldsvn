...
int         g_ReadOnlyPlayback = 1;     // 1 means play a movie. 0 means play movie then resume recording
int         g_ResumeRecording = 0;      // 0 means play a movie. 1 means resume recording from end of current file.
