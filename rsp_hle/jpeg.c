...
void jpg_uncompress(OSTask_t *task)
{
    ...
    {
//#ifdef __WIN32__
//    MessageBox(NULL, "!flags", "!flags", MB_OK); // these are commented due to focus issues (gnu+linux) if they're not.
//#else
        printf("!flags\n");
//#endif
    }
    ...
    // zigzag
        ...
        {
//#ifdef __WIN32__
//         MessageBox(NULL, "h==0", "h==0", MB_OK); // these are commented due to focus issues (gnu+linux) if they're not.
//#else
            printf("h==0\n");
//#endif
        }
