...
inline_readstub(int type, u_int addr, signed char regmap[], int target, int adj, u_int reglist)
{
...
inline_writestub(int type, u_int addr, signed char regmap[], int target, int adj, u_int reglist)
{
...
void fconv_assemble_arm(int i,struct regstat *i_regs)
{
  ...
  if(rs<4||rs==12) emit_loadreg(CSREG,rs);
}
